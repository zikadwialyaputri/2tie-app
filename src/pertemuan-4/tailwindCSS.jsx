    ...
    <div>
      ...
      <button
        className="bg-blue-500 text-white
                    px-4 py-2 mx-4 rounded shadow-lg">Click Me
      </button>
      <Spacing/>
      <Typography/>
      <BorderRadius/>
...
function Typography(){
    return (
        <div>
            ...
            <p className="text-green-900 text-lg mt-2">Belajar Tailwind sangat menyenangkan dan cepat!</p>
        </div>
    )
}
...
function ShadowEffects(){
    return (
        <div className="bg-white shadow-lg p-6 rounded-lg hover:shadow-blue-200 transition">
